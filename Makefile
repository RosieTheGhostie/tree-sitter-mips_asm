LANGUAGE_NAME := tree-sitter-mips-asm
HOMEPAGE_URL := https://github.com/rosietheghostie/tree-sitter-mips_asm
VERSION := 0.0.1
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/mips-asm '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/mips-asm
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/mips-asm
